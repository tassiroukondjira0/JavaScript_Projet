-- Djokko Social Network - Complete MySQL Database
...
-- Pour réinitialiser complètement la base et supprimer toutes les données existantes,
-- exécutez d'abord ces commandes AVANT d'importer ce script :
--
...
--
-- Ou importez simplement ce fichier dans une base vierge nommée `djokko`.
